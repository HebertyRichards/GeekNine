...
<body>
  ...
  <div class="chip">
    <h1 id="h1"> ROG Strix Scar 18 (2024) é um notebook monstruoso <br>com RTX 4090 e Intel Core i9 - Review </h1>
    <div class="chip-b">
      <img src="imagens/rog-t1.gif" alt="ROG-T11">
    </div>
    <div class="chip-c">
      <p>Os notebooks costumam ser a pedida certa para quem busca portabilidade, enquanto os desktops (computadores de mesa) servem mais potência, porém com um visual mais “caixotão”. No entanto, com a rápida evolução do mercado de hardware, já existem soluções que combinam um design compacto com poder puro.</p>
    </div>
    ...
    <h2 id="sub">Especificações completas</h2>
    ...
    <h2 id="sub">Design gamer e com muitas luzes</h2>
    ...
    <div class="chip-b">
      <img src="imagens/rog-t2.jpeg" alt="ROG-t12">
    </div>
    ...
    <h2 id="sub">Uma tela MiniLED de respeito</h2>
    ...
    <h2 id="sub">O ROG Strix Scar 18 esquenta e faz barulho?</h2>

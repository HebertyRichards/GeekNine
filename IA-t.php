...
<body>
  ...
  <div class="chip">
    <h1 id="h1"> A inteligência artificial vai substituir os desenvolvedores? </h1>
    <H3>Entenda como aspectos fundamentalmente humanos podem garantir o futuro da profissão</H3>
    <div class="chip-b">
      <img src="imagens/ia-2.jpeg" alt="Inteligencia Artificial>
      </div>
     <div class=" chip-c">
      ...
      <div class="chip-b">
        <img src="imagens/ia-4.gif" alt="Inteligencia Artificial">
      </div>

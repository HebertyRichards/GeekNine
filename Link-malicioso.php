  ...
  <div class="chip">
    ...
    <div class="chip-c">
      <p>Um estudo divulgado pela Associação de Dados Pessoais e Consumidor (ADDP) revelou que, apenas em 2023, houve um aumento entre 25% e 35% no número de ataques cibernéticos, muitos deles envolvendo URLs. Com isso, a pergunta que fica no ar é: como se prevenir e evitar essas ameaças por meio de link malicioso?
        Caso esteja com essa pergunta na cabeça, confira abaixo algumas dicas que ajudam a evitar esse problema.</p>
    </div>
    <p>
    ...
    <h2 id="sub">1. Verifique se o site usa HTTPS</h2>
    <div class="chip-b">
    ...
    <h2 id="sub">2. Usar uma ferramenta de verificação de link</h2>
    ...
    <h2 id="sub">3.Cheque os dados de contato</h2>
    <div class="chip-b">
    ...
    <h2 id="sub">4. Observe as avaliações do Google</h2>
    ...
    <h2 id="sub">5. Avalie a propriedade do domínio</h2>
    ...
    <h2 id="sub">6. Acesse o site apenas por vias seguras</h2>

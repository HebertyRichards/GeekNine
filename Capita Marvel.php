...
<body>
  ...
  <div class="container-a">
    <img src="imagens/Capita.png" alt="Capitã Marvel">
    <div class="div1">
      <h1 id="h1">Capitã Marvel</h1>
      <div class="mdb">
        <p>2019</p>
        <p>2h, 3m p</p>
        <a href="https://www.imdb.com/title/tt4154664/?ref_=fn_al_tt_1">6.8/10</a>
      </div>
      <div class="elenco">
        <img src="imagens/Brie Larson.png" alt="Brie Larson">
        <span>Brie Larson</span>
        <img src="imagens/Samuel L. Jackson.png" alt="Samuel L. Jackson">
        <span>Samuel L. Jackson</span>
        <img src="imagens/Ben Mendelsohn.png" alt="Ben Mendelsohn">
        <span>Ben Mendelsohn</span>
        <img src="imagens/Jude Law.png" alt="Jude Law">
        <span>Jude Law</span>
      </div>
      <div class="texto1">
        <p>Em Capitã Marvel, Carol Danvers (Brie Larson) é uma ex-agente da Força Aérea norte-americana, que, sem se
          lembrar de sua vida na Terra, é recrutada pelos Kree para fazer parte de seu exército de elite. Inimiga
          declarada dos Skrull, ela acaba voltando ao seu planeta de origem para impedir uma invasão dos metaformos, e
          assim vai acabar descobrindo a verdade sobre si, com a ajuda do agente Nick Fury (Samuel L. Jackson) e da
          gata Goose.</p>
      </div>
    </div>
  </div>

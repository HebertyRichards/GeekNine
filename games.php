<?php
session_start();
$jsonData = file_get_contents('data/games.json');
  ...
  <div class="container-a">
    ...
    <p>O Mundo Game na GEEKNINE é um local onde você encontra uma grende variedade de comundades</p>
      <p>interagindo 
       ...
       divertir. </p>
        <p>Embarque nessa aventura conosco!</p>
     <h3>Tendências</h3>
     <p>Os mais queridos do momento!</p>  
      <?php foreach ($data as $category => $games): ?>
                  ...
                  <?php foreach ($games as $game): ?>
                      <div class="game">
                          <a href="<?php echo $game['link']; ?>">
                              <img src="<?php echo $game['img']; ?>" alt="<?php echo $game['titulo']; ?>">
                          </a>
                          <p><?php echo $game['titulo']; ?></p>
                      </div>
                  <?php endforeach; ?>
              </div>
          </div>

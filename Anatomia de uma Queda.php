...
<body>
  ...
  <div class="container-a">
    ...
    <div class="div1">
      <h1 id='h1'>Anatomia de Uma Queda</h1>
      <div class="mdb">
        <p>2023</p>
        <p>2h, 31m </p>
      ...
      <div class="elenco">
        <img src="imagens/Sandra Hüller.png" alt="Sandra Hüller">
        <span>Sandra Hüller</span>
        <img src="imagens/Swann Arlaud.png" alt="Swann Arlaud">
        <span>Swann Arlaud</span>
        <img src="imagens/Milo Machado-Graner.png" alt="Milo Machado-Graner">
        <span>Milo Machado-Graner</span>
        <img src="imagens/Antoine Reinartz.png" alt="Antoine Reinartz">
        <span>Antoine Reinartz</span>
      </div>
      <div class="texto1">

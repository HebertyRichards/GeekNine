...
<body>
  ...
  <div class="chip">
    <h1 id="h1">Apple apresenta os novos notebooks MacBook Air de 13<br> e 15 polegadas com o poderoso chip M3</h1>
    ...
    <div class="chip-b">
      <img src="imagens/mac-3.jpeg" alt="Mac-3">
    </div>
    <div class="chip-c">
      ...
      <p>
        “O MacBook Air é o nosso Mac mais popular e mais amado. A maioria dos clientes prefere esse notebook a qualquer outro. E, hoje, ele fica ainda melhor com o chip M3 e novos recursos”, afirma Greg Joswiak, senior vice president of Worldwide Marketing da Apple. “De universitários em busca do diploma a usuários corporativos atrás de produtividade, ou qualquer pessoa que simplesmente queira a combinação imbatível de desempenho, portabilidade e bateria líder do setor em um design sem ventoinha, o novo MacBook Air continua sendo o melhor notebook fino e leve do mundo.”</p>
      </p>
      <div class="chip-b">
        <img src="imagens/mac-1.jpeg" alt="Mac-1">
      </div>
      <h2 id="sub">Desempenho impressionante com o chip M3:</h2>
      ...
      <h2 id="sub"> O chip M3 potencializa ainda mais o desempenho do MacBook Air:</h2>
      ...
      <h2 id="sub">O melhor notebook pessoal do mundo para IA</h2>
      <p> Com a mudança para o chip da Apple, qualquer um dos modelos de Mac é uma plataforma perfeita para inteligência artificial (IA). O M3 inclui um Neural Engine de 16 núcleos mais rápido e mais eficiente, além de aceleradores na CPU e na GPU para incrementar o aprendizado de máquina no aparelho, tornando o MacBook Air o melhor notebook pessoal do mundo para IA. Aproveitando esse desempenho de IA incrível, o macOS disponibiliza recursos inteligentes que aumentam a produtividade e a criatividade, para o usuário ativar funções avançadas da câmera, vocalização de texto em tempo real, tradução, sugestões de texto, compreensão visual, recursos de acessibilidade e muito mais.
        <br> Com um amplo ecossistema de apps que oferecem recursos avançados de IA, é possível, por exemplo, conferir a tarefa da escola com o AI Math Assistance no Goodnotes 6, editar fotos automaticamente no Pixelmator Pro ou remover o ruído de fundo de um vídeo usando o CapCut. Combinado com a arquitetura de memória unificada do chip da Apple, o MacBook Air também consegue rodar modelos de IA otimizados, incluindo grandes modelos de linguagem (LLMs) e modelos de difusão para gerar imagens localmente com maior qualidade. Além do desempenho no aparelho, o MacBook Air é compatível com soluções na nuvem, permitindo rodar apps de produtividade e criatividade que usam IA, como Microsoft Copilot para Microsoft 365, Canva e Adobe Firefly.
        O notebook mais popular do mundo
        <br> Mais pessoas optam pelo MacBook Air, e o chip M3 eleva o nível mais uma vez com sua combinação fenomenal de desempenho, portabilidade e recursos que os usuários adoram: <br> Dois tamanhos perfeitos em um design superportátil: com uma estrutura de alumínio resistente que foi projetada para durar, os notebooks MacBook Air de 13 e 15 polegadas têm uma bateria com duração fantástica, são incrivelmente leves e têm quase 11 mm de espessura. Assim, os usuários podem trabalhar, jogar ou criar em qualquer lugar. O modelo de 13 polegadas oferece o máximo de portabilidade, enquanto o modelo de 15 polegadas tem mais espaço na tela para multitarefa. Existe um tamanho perfeito para todo mundo, de estudantes com várias aulas por dia a profissionais que preferem uma tela maior.
        <br> Linda tela Liquid Retina: o MacBook Air vem com uma tela Liquid Retina de 13,6 polegadas ou 15,3 polegadas com até 500 nits de brilho, suporte a um bilhão de cores e até o dobro de resolução em comparação com os notebooks PC. O conteúdo ganha mais detalhes, e o texto fica supernítido.
        <br> Compatibilidade com até dois monitores externos: o MacBook Air com M3 agora conecta até dois monitores externos quando está fechado — ideal para usuários corporativos ou qualquer pessoa que precise de várias telas para multitarefa em diferentes apps ou visualização de diversos documentos ao mesmo tempo.
        <br> Conexões versáteis: o MacBook Air com M3 conta com Wi-Fi 6E, que oferece até o dobro de velocidade no download da geração anterior. Além disso, inclui uma porta MagSafe para recarga, duas portas Thunderbolt para conectar acessórios e uma entrada de 3,5 mm para fones de ouvido.
        <br> Câmera, microfones e alto-falantes: com uma câmera FaceTime HD de 1080p, os usuários ficam bem em qualquer situação, seja uma conversa com amigos e a família ou uma reunião de trabalho com colegas de outros lugares do mundo. O som também fica melhor graças ao conjunto de três microfones e maior clareza na voz em chamadas de áudio e vídeo. O MacBook Air tem um sistema de som envolvente compatível com Áudio Espacial e Dolby Atmos para criar uma experiência tridimensional em filmes e música. <br> Magic Keyboard e Touch ID: o Magic Keyboard retroiluminado é confortável e silencioso. As teclas de função têm o mesmo tamanho do restante do teclado. E ele vem com o Touch ID, uma forma rápida, fácil e segura de desbloquear o Mac, iniciar sessão em apps e sites e fazer compras usando o Apple Pay com apenas um toque.
      </p>
    </div>
  </div>
